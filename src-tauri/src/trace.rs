...
use zerocopy::{FromBytes, Unaligned, KnownLayout, Immutable};
...
#[derive(FromBytes, Unaligned, KnownLayout, Immutable, Debug, Copy, Clone, Serialize, Deserialize)]
#[repr(C)]
pub struct Header {
  pub magic: [u8; 5],
  pub version: u8,
  pub num_commands: u8,
  pub reserved: u8,
  #[serde(serialize_with = "serialize_leu64", deserialize_with = "deserialize_leu64")]
