<template>
  ...
  <div class="space-y-6 py-6">
    <UFormField label="Number of Channels">
      <UInput v-model="memoryLayout.numChannels" placeholder="0" type="number" class="w-full" size="lg" />
    </UFormField>
    <UFormField label="Bankgroups per Channel">
      <UInput v-model="memoryLayout.numBankgroups" placeholder="0" type="number" class="w-full" size="lg" />
    </UFormField>
    <UFormField label="Banks per Bankgroup">
      <UInput v-model="memoryLayout.numBanks" placeholder="0" type="number" class="w-full" size="lg" />
    </UFormField>
  </div>
